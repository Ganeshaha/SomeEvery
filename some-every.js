...
function hasOddNumber(arr) {
   ...
   return arr.some(function(value, index, passedArr){
...
function hasAZero(num) {
    ...
    //used this code to convert num into an Array

    // console.log(num);
    // console.log(typeof num);
    let tempArr = Array.from(String(num), Number);
    console.log(tempArr);
    return tempArr.some(function(value, index, passedArr){
...
function hasOnlyOddNumbers(arr) {
    ...
    return arr.every(function(value, index, passedArr){
        if(value%2){
            return true;
        }
...
and a value, and returns true if every single object in the array contains that value for the specific key.
...
function hasCertainValue(arr, key, searchValue) {
    ...
    return arr.every(function(value, index, passedArr){
        ...
        if(value[key]&& value[key]===searchValue){
            return true;
        }
        else return false;
    })
